* Next Steps
** TODO Check out Bahrain grand prix and see if we can see better indications of deg

** TODO Could Also Look at Free Practice Data

** TODO Looking between teams in a race

** TODO Implement CRPS for comparison to other Bayesian models

** TODO Keep in mind the idea of some kind of tire degredation measurements that could be displayed in an F1 broadcast
** DONE Fit full model (all stints) [3/4]
CLOSED: [2025-09-30 Tue 09:45] DEADLINE: <2025-09-28 Sun>
Look into CRPS for Bayesian test stat for CV
- [X] Cross validation scheme
- [ ] Simulate from some different models to do CV
- [X] Fit on a nice race and talk about parameter estimates
  - Did leclerc
- [X] Need to have a skeleton (base) model to say hey my model does better
  - Will try fitting ARIMA and then doing CV
    
** TODO Latex Template for JQAS
...
- [X] For some of the more weird deg trajectories, we were getting negative estimates for b.  We can set a lower bound on this or play around with different priors.
  - Set a lower bound
** DONE Ask Ian and/or Andy about Sensitivity Analysis for Priors
CLOSED: [2025-09-16 Tue 13:40] DEADLINE: <2025-09-16 Tue>
...
** DONE Send Andy what I have so far for the writing project
CLOSED: [2025-09-09 Tue 08:55]
  
** DONE NSF Grant
CLOSED: [2025-09-19 Fri 20:55] DEADLINE: <2025-09-19 Fri>

** DONE Could start writing out model and thinking about interpretation of coefficients
CLOSED: [2025-10-14 Tue 12:14]

** DONE Compare other state space models to ours on real data
CLOSED: [2025-10-14 Tue 12:14]
...
*** DONE Chapter 3 Model Specs Rough Draft
CLOSED: [2025-10-15 Wed 10:53] DEADLINE: <2025-10-12 Sun>
