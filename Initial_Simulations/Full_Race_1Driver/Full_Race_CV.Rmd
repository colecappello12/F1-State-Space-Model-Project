...
I'm going to load lap time data from the Hungarian Grand Prix for various drivers.  We'll do cross validation on Charles Leclerc's race because - while I admit I am slightly partial - he does seem to have a race that conforms well to our model. Here is a visual of Leclerc's laptimes:
